...
function Index() {
          ...
          <Navbar/>
            ...
            <dh-component>
                <nav className="w-full">
                    <div className="container mx-auto px-6 flex items-center justify-center">
                        <div className="flex items-center" aria-label="Home" role="img">
                            <img className="cursor-pointer w-8 sm:w-auto" src={Logodownload} alt="logo" />
                        </div>
                        <div>
                ...
                <div className="w-full px-6">
                    <div className="mt-8 relative rounded-lg bg-gray-400 container mx-auto flex flex-col items-center pt-12 sm:pt-24 pb-24 sm:pb-32 md:pb-48 lg:pb-56 xl:pb-64">
                        ...
                        <div className="w-11/12 sm:w-2/3 mb-5 sm:mb-10">
                            <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl text-center text-Black font-bold leading-tight">Mainkan sekarang juga</h1>
                        </div>
                        <div className="flex justify-center items-center mb-10 sm:mb-20">
                            <button className="hover:text-black hover:bg-transparent lg:text-xl hover:border-black border bg-black transition duration-150 ease-in-out focus:outline-none focus:ring-2 focus:ring-offset-2 ring-offset-indigo-700	focus:ring-white rounded text-white px-4 sm:px-8 py-1 sm:py-3 text-sm">Download Now</button>
                            <button className="hover:bg-white hover:text-indigo-600 lg:text-xl hover:border-indigo-600 ml-3 sm:ml-6 bg-transparent transition duration-150 ease-in-out focus:outline-none focus:ring-2 focus:ring-offset-2 ring-offset-indigo-700 focus:ring-white hover:bg-indigo-700-800 rounded border border-black text-black px-4 sm:px-8 py-1 sm:py-3 text-sm">Learn More</button>
                        </div>
                    </div>
                    <div className="container mx-auto flex justify-center md:-mt-56 -mt-20 sm:-mt-40">
                        <div className="relative justify-center ">
                            <img src= {Slide1} alt="Sample Page" role="img" />
                        </div>
                    </div>
                </div>
            </dh-component>
  ...
  <div class="mx-6 py-10 text-center md:text-left">
    <div class="grid grid-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
      ...
      <div class="">
        ...
        <p class="mb-4">
          <a href="#!" class="text-gray-600">Erangrl</a>
        </p>
        <p class="mb-4">
          <a href="#!" class="text-gray-600">Miramar</a>
        </p>
        <p class="mb-4">
          <a href="#!" class="text-gray-600">Sanhok</a>
        </p>
        <p>
          <a href="#!" class="text-gray-600">Vikendi</a>
        </p>
      </div>
      <div class="">
        <h6 class="uppercase font-semibold mb-4 flex justify-center md:justify-start">
        ...
        <p class="mb-4">
          <a href="#!" class="text-gray-600">PUBG X WARFRAME</a>
        </p>
        <p class="mb-4">
          <a href="#!" class="text-gray-600">PUBG X GODZILLA</a>
        </p>
        <p class="mb-4">
          <a href="#!" class="text-gray-600">MIRROR WORLD</a>
        </p>
        <p>
          <a href="#!" class="text-gray-600">LUCKY GIFTS</a>
        </p>
      </div>
      <div class="">
        <h6 class="uppercase font-semibold mb-4 flex justify-center md:justify-start">
  ...
  <div class="text-center p-6 bg-black">
    ...
    <a class="text-white font-semibold" href="Home"> Player unknown battle ground Website Download</a>
  </div>
</footer>
        </div>
